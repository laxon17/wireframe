    ...
    else 
    {
        ...
        if(!$found) 
        {
            ...
            try
            {
                ...
                $mail->Body    = "Please verify your account by clicking the link: <a href=\"http://localhost:8800/verify?token=$verification_token\">Verify</a>";
                $mail->AltBody = "Please verify your account by clicking the link: http://localhost:8800/verify?token=$verification_token";
